<?php
  ...
  $producs = $bdd->query('SELECT * FROM produits ORDER BY date_publication DESC LIMIT 0,3');
?>
<!------------------------------------------------------------------------------------------>
...
<html lang="en">
  ...
  <body>
    ...
    <header>
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('img/slide-cou.png')">
    ...
    <div class="container">
      ...
      <h1 class="my-4" style="text-align: center;">Iaorana Maeva sur KittyHei</h1>
      ...
      <?php while ($row = $producs->fetch()) { ?>
        <div class="col-lg-4 mb-4">
          <div class="card h-100 text-center">  
            <h4 class="card-header" style="background-color: rgb(209, 130, 255);"><?= $row['model']?></h4>
            <img style="width: 350px; height: 250px;" class="img-fluid thumbnail" src="../img/producs/<?= $row['picture'] ?> "/>
            <div class="card-footer" style="background-color: rgb(209, 130, 255);">
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="couronnes.php">Project One</a>
              </h4>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="couronnes.php">Project Two</a>
              </h4>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="couronnes.php">Project Three</a>
              </h4>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="couronnes.php">Project Four</a>
              </h4>
              <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="couronnes.php">Project Five</a>
              </h4>
              <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="couronnes.php">Project Six</a>
              </h4>
      ...
      <div class="row mb-4">
        ...
        <div class="col-md-4">
          <a class="btn btn-lg btn-success btn-block" href="#">Call to Action</a>
        </div>
      </div>
